...
import '../widget/pick_images.dart';
import '../widget/select_roll.dart';
...
class _SignUpPageState extends State<SignUpPage> {
                        ...
                        builder: (context, setStateInternal) {
                          return (ischoosing == false)? ElevatedButton(
                            ...
                            onPressed: () async {
                              ...
                              if(path_card != null) {
                                print("name file: ${path_card!.path}, size file: ${path_card!.lengthSync() / (1024 * 1024)}");
                              }
                              ischoosing = false;
                              setStateInternal((){});
                            },
              ...
              Form(
                ...
                child: Column(
                  children: [
                    ...
                    //       },
                    //       rollValue: registerController.role.value,
                    //       // rollValue: registerController.onChange(value),
                                    ...
                                    child: Material(
                                      ...
                                      child: DropdownSearch<TypeJobItem>(
                                        ...
                                        popupProps: PopupProps.modalBottomSheet(
                                            ...
                                            // disabledItemFn: (TypeJobItem item) {
                                            //   return item.id == 1;
                                            // },
                    ...
                    //           onChange: (value) {
                    //             registerController.selectJob(value);
                    //           },
                    //         ),
                    //       ),
                    //     );
  ...
  //     print(registerController.role.value);
  //     print(registerController.selectJob.value);
  //     print(onTapController);
  //   } else {
  //     return null;
  //   }
  // }
